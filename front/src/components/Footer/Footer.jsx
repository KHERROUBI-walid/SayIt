  ...
  return (
    <StyledWrapper>
     <div className='footer'>
      <div className="card">
          <button className="button Chat" onClick={handleChatClick}><svg viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" className="svg">
        ...
        <button className="button Post" onClick={handlePostClick}>
        ...
        <button className="button Explore" onClick={handleExploreClick}><svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" className="svg">
